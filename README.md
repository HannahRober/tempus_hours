...
```javascript
javascript:(function(){var script = document.createElement('script');script.src = "https://hannahrober.github.io/tempus_hours/clean_tempus.js";script.onload = function() {console.log("Tempus Month Manager loaded");};script.onerror = function() {alert("Failed to load Tempus script");};document.head.appendChild(script);})();
```
